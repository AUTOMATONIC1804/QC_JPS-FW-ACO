"""
aco_runner_dijkstra.py
----------------------
ACO station optimization for the Dijkstra variant.
"""
...
# === File Paths (Dijkstra Variant) ===
POINTS_FILE = Path(r"D:\Quezon_City\data\outputs\floyd_warshall\fw_dijkstra_points.geojson")
ROADS_FILE  = Path(r"D:\Quezon_City\data\outputs\floyd_warshall\fw_dijkstra_roads.geojson")
DIST_FILE   = Path(r"D:\Quezon_City\data\outputs\floyd_warshall\fw_dijkstra_D.npy")
PATH_FILE   = Path(r"D:\Quezon_City\data\outputs\dijkstra_path.geojson")
OUTPUT_DIR  = Path(r"D:\Quezon_City\data\outputs\aco")

def main():
    print("🧭 ACO Station Optimization (Dijkstra variant)")
    ...
    out_points = OUTPUT_DIR / "aco_optimal_stations_dijkstra.geojson"
    out_route  = OUTPUT_DIR / "aco_optimal_route_dijkstra.geojson"
    out_csv    = OUTPUT_DIR / "aco_summary_dijkstra.csv"
